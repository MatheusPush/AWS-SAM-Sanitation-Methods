...
This is a sample template for san - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name san --tail
```
...
```bash
aws cloudformation delete-stack --stack-name san
```
